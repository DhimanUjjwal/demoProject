<div class="card">
        ...
        <div class="card-subtitle">Email: {{$item->email}}</div>
        <div class="card-subtitle">~About~</div>
        <div class="card-subtitle"><p>Lorem, ipsum dolor sit amet consectetur adipisicing elit. Quis totam dignissimos labore voluptates asperiores, earum odit fugiat? Nihil totam dolorem sunt excepturi maiores, est quos ut quae dignissimos blanditiis laboriosam.</p></div>
